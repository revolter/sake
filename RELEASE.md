...
3. Validate the state of the project by executing `swift run sake task ci`
4. Generate the release with `swift run sake task release`.
5. Create a new release on [GitHub](https://github.com/xcodeswift/sake) including the information from the last entry in the `CHANGELOG.md`.
